                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ...
                    <button
                      key={option.color}
                      onClick={() =>
                        setAccentColor(option.color as AccentColor)
                      }
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: snowflakesEnabled
                        ? "#3B82F6"
                        : "#6B7280",
                    }}
                  >
                ...
                <div
                  className="mt-3 p-3 rounded-lg bg-white/5 backdrop-blur-sm"
                ...
                >
                  <p
                    ...
                    style={{ color: currentTheme.textSecondary }}
                  >
                    Добавляет праздничную атмосферу с анимированными снежинками
                    на фоне приложения
                  </p>
                </div>
              </div>
